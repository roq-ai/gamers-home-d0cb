...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Project.create': { roles: ['freelancer', 'admin'], key: 'project_create', tenantPath: [], userPath: [] },
  'Project.update': { roles: ['freelancer', 'admin'], key: 'project_update', tenantPath: [], userPath: [] },
  'Payment.create': { roles: ['freelancer', 'admin'], key: 'payment_received', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['freelancer'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['freelancer', 'admin'];
